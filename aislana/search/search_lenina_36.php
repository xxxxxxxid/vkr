...
<?
 ...
 <tr>
  <td><?echo $row['aud']?></td>
  <td><?echo $row['komp']?></td>
  <td style='border-left: none;'><?echo "<a href='search_lenina_36.php?id=$row[aud]#modal' class='mod' title='Подробно'><img src='../images/dop.png' width= '25px' height= '25px'></a>";?></td>
  <td><?echo $row['kol']?></td>
</tr><?  
}
$i++;
