...
if(isset($_POST['save'])){
	$result = mysqli_query( $link, "UPDATE stud_gorod SET aud = '{$_POST['aud']}', year = '{$_POST['year']}', komp = '{$_POST['komp']}', kol= '{$_POST['kol']}', korpus_id = '{$_POST['korpus_id']}' WHERE id = '{$_POST['id']}'");
if($result == true)
?><meta http-equiv="refresh" content="0.5;URL=../edit/edit_stud_gorod.php"><?php
}
if(isset($_GET['id'])){
$id = $_GET['id'];
$sql = mysqli_query($link, "SELECT * FROM stud_gorod WHERE id =$id ");
